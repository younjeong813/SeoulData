...
def question_page():
    ...
    unique_key = f"question_{current_index}"
    user_input = st.text_input(
        "", value=st.session_state.user_data.get(key, ""), key=unique_key
    )
    st.session_state.user_data[key] = user_input  # 입력된 데이터를 session_state에 저장
